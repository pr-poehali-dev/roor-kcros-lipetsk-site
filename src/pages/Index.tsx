    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <img src="https://cdn.poehali.dev/projects/10e7fd4c-5234-4d78-be4b-8a34049f73f2/files/438f90ee-c1dd-4905-9abc-b465a1746af5.jpg" alt="РООР КЦРОС" className="h-12 w-auto" />
              <div>
          ...
          <div className="space-y-8 animate-fade-in">
            <section className="bg-gradient-to-br from-primary/10 to-accent/5 rounded-lg p-8 md:p-12">
              <div className="max-w-3xl">
                <div className="flex items-start gap-4 mb-6">
                  <img src="https://cdn.poehali.dev/projects/10e7fd4c-5234-4d78-be4b-8a34049f73f2/files/438f90ee-c1dd-4905-9abc-b465a1746af5.jpg" alt="РООР КЦРОС" className="h-20 w-auto" />
                  <div>
            ...
            <section className="grid md:grid-cols-3 gap-6">
              <Card className="hover:shadow-lg transition-shadow">
                <CardHeader>
                  <div className="w-12 h-12 bg-white rounded-lg flex items-center justify-center mb-2 p-1">
                    <img src="https://cdn.poehali.dev/projects/10e7fd4c-5234-4d78-be4b-8a34049f73f2/files/438f90ee-c1dd-4905-9abc-b465a1746af5.jpg" alt="Документы" className="h-full w-auto" />
                  </div>
              ...
              <Card className="hover:shadow-lg transition-shadow">
                <CardHeader>
                  <div className="w-12 h-12 bg-white rounded-lg flex items-center justify-center mb-2 p-1">
                    <img src="https://cdn.poehali.dev/projects/10e7fd4c-5234-4d78-be4b-8a34049f73f2/files/438f90ee-c1dd-4905-9abc-b465a1746af5.jpg" alt="Реестры" className="h-full w-auto" />
                  </div>
              ...
              <Card className="hover:shadow-lg transition-shadow">
                <CardHeader>
                  <div className="w-12 h-12 bg-white rounded-lg flex items-center justify-center mb-2 p-1">
                    <img src="https://cdn.poehali.dev/projects/10e7fd4c-5234-4d78-be4b-8a34049f73f2/files/438f90ee-c1dd-4905-9abc-b465a1746af5.jpg" alt="Новости" className="h-full w-auto" />
                  </div>
      ...
      <footer className="bg-secondary text-white mt-16 py-12 border-t border-border relative overflow-hidden">
        <div className="absolute right-0 bottom-0 opacity-5 pointer-events-none">
          <img src="https://cdn.poehali.dev/projects/10e7fd4c-5234-4d78-be4b-8a34049f73f2/files/438f90ee-c1dd-4905-9abc-b465a1746af5.jpg" alt="" className="h-64 w-auto" />
        </div>
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              <div className="flex items-center gap-3 mb-4">
                <img src="https://cdn.poehali.dev/projects/10e7fd4c-5234-4d78-be4b-8a34049f73f2/files/438f90ee-c1dd-4905-9abc-b465a1746af5.jpg" alt="РООР КЦРОС" className="h-16 w-auto" />
                <div>
